...
public class CustomGuiTextField extends Gui
{
    ...
    private final String unFocusedText;
    private boolean isPassword = false;

    public CustomGuiTextField(int componentId, FontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height, String unFocusedText)
    {
        this.id = componentId;
    ...
    private String repeat(final String original) {
        if (!isPassword) return original;
        final StringBuilder sb = new StringBuilder();
        for(int i = 0; i < original.length(); ++i) sb.append("*");
        return sb.toString();
    }
...
//                drawRect(this.xPosition - 1, this.yPosition - 1, this.xPosition + this.width + 1, this.yPosition + this.height + 1, -6250336);
                drawRect(this.xPosition, this.yPosition + height - 1, this.xPosition + this.width, this.yPosition + this.height, new Color(60, 60, 60).getRGB());
            }

            if (text.isEmpty() && !isFocused) {
                this.fontRendererInstance.drawString(this.unFocusedText, this.xPosition + 4, this.yPosition + this.height - this.fontRendererInstance.FONT_HEIGHT - 3, -1);
            }
            ...
            if (s.length() > 0)
            {
                ...
                j1 = this.fontRendererInstance.drawStringWithShadow(repeat(s1), (float)l, (float)i1, i);
            }
            ...
            {
                j1 = this.fontRendererInstance.drawStringWithShadow(repeat(s.substring(j)), (float)j1, (float)i1, i);
            }
