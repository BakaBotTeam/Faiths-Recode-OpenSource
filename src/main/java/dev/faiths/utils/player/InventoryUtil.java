...
public final class InventoryUtil {
    ...
    public static boolean isGoodItem(final ItemStack stack) {
        ...
        return item instanceof ItemEnderPearl || item == Items.arrow || item == Items.lava_bucket || item == Items.water_bucket || HYTUtils.isGodAxe(stack) || HYTUtils.isKBBall(stack);
    }
    ...
    public static double getDamageReduction(final ItemStack stack) {
        ...
        reduction += armor.damageReduceAmount * 1000;
