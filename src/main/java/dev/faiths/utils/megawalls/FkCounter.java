package dev.faiths.utils.megawalls;
...
public class FkCounter {
    ...
    private static String PREP_PHASE = "Prepare your defenses!";
    ...
    private static String[] SCOREBOARD_PREFIXES = new String[] { "[R]", "[G]", "[Y]", "[B]" };
    private static String[] DEFAULT_PREFIXES = new String[] { "c", "a", "e", "9" };
