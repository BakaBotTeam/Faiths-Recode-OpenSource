...
public class KillAuraACheck extends Check {
    ...
    public boolean check(EntityPlayer player, PlayerDataSamples data) {
        ...
        final PlayerDataSamples targetData = data.attackInfo.target.getPlayerDataSamples();
            ...
            if (!nearbyPlayers.isEmpty() && nearbyPlayers.size() < 15) {
                for (int j = 0; j < iterMax + 1; j++) {
                    ...
                    for (final EntityPlayer entity : nearbyPlayers) {
                        final PlayerDataSamples eData = entity.getPlayerDataSamples();
    ...
    public static ViolationLevelTracker newVL() {
        return new ViolationLevelTracker(0, 1, 5);
    }
