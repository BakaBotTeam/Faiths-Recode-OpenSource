...
import dev.faiths.event.EventCancelledException;
...
public class PacketThreadUtil
{
    ...
    public static <T extends INetHandler> void checkThreadAndEnqueue(final Packet<T> p_180031_0_, final T p_180031_1_, IThreadListener p_180031_2_) throws ThreadQuickExitException
    {
        ...
        {
            PacketEvent packetReceive = new PacketEvent(PacketEvent.Type.RECEIVE, p_180031_0_,p_180031_1_);
            if(Minecraft.getMinecraft().thePlayer != null) Faiths.INSTANCE.getEventManager().callEvent(packetReceive);
