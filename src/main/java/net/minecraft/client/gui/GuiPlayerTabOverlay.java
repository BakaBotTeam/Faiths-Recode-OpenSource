...
public class GuiPlayerTabOverlay extends Gui
{
    ...
    public String getPlayerName(NetworkPlayerInfo networkPlayerInfoIn) {
        ...
        /*if (IRC.connected && IRC.playerMap.containsValue(networkPlayerInfoIn.getGameProfile().getName())) {
            String userName = IRC.getUsernameInGame(networkPlayerInfoIn.getGameProfile().getName());
            str = String.format(EnumChatFormatting.GREEN + "%s %s", IRC.getUserTag(userName), str);
        }*/
            try {
                if (SilenceFixIRC.Instance.ircUserMap.containsKey(networkPlayerInfoIn.getGameProfile().getId())) {
                    str = SilenceFixIRC.Instance.getUserTag(networkPlayerInfoIn.getGameProfile().getId()) + str;
                }
            } catch (Exception ignored) {}

        /*ModuleHypixelUtils hypixelUtils = Faiths.moduleManager.getModule(ModuleHypixelUtils.class);
        if (hypixelUtils.getState() && hypixelUtils.playerTag.containsKey(networkPlayerInfoIn.getGameProfile().getName())) {
            str = hypixelUtils.playerTag.get(networkPlayerInfoIn.getGameProfile().getName()) + str;
        }*/
