...
public class EffectRenderer
{
    ...
    private CopyOnWriteArrayList<EntityParticleEmitter> particleEmitters = new CopyOnWriteArrayList<>();
    ...
    public void updateEffects()
    {
        ...
        CopyOnWriteArrayList<EntityParticleEmitter> list = new CopyOnWriteArrayList<>();
