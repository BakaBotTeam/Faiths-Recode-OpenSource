...
public class ItemRenderer {
    ...
    private void doBlockTransformations2() {
        GlStateManager.translate(-0.5F, -0.05F, 0.0F);
        GlStateManager.rotate(30.0F, 0.0F, 1.0F, 0.0F);
        GlStateManager.rotate(-80.0F, 1.0F, 0.0F, 0.0F);
        GlStateManager.rotate(60.0F, 0.0F, 1.0F, 0.0F);
    }
            ...
            if (this.itemToRender != null) {
                ...
                if (this.itemToRender.getItem() instanceof ItemMap) {
                    ...
                    switch (enumaction) {
                        ...
                        case BLOCK:
                            this.renderBlockingAnimation(f1, f);
                            break;
                ...
                } else if ((ModuleKillAura.shouldBlock() && mc.thePlayer.getHeldItem() != null && mc.thePlayer.getHeldItem().getItem() instanceof ItemSword)) {
                    enumaction = EnumAction.BLOCK;
                    this.renderBlockingAnimation(f1, f);
                } else {
                    if (!ModuleAnimation.swingAnimation.getValue()) {
                ...
                if (enumaction == EnumAction.NONE) {
                    GlStateManager.translate(ModuleAnimation.xArm.getValue(), ModuleAnimation.yArm.getValue(), ModuleAnimation.zArm.getValue());
                }
    ...
    // Client
    public void renderBlockingAnimation(float swingProgress, float equippedProgress) {
        float f;
        float f1;
        GlStateManager.translate(ModuleAnimation.x.getValue(), ModuleAnimation.y.getValue(), ModuleAnimation.z.getValue());

        switch (ModuleAnimation.swordAnimation.getValue()) {
            case "Slide":
                this.transformFirstPersonItem(equippedProgress - 0.2f, 0.0F);
            ...
            case "Spin":
                ...
                GlStateManager.translate(0.0F, equippedProgress * -0.6F, 0.0F);
                GlStateManager.rotate(RenderUtils.getRotateDirection(), 0.0F, 1.0F, 0.0F);
            ...
            case "Screw":
                ...
                GlStateManager.rotate(RenderUtils.getRotateDirection(), 0.7F, 1.0F, 1.0F);
                GlStateManager.rotate(64F, 1.0F, 1.0F, 0.0F);
                GlStateManager.scale(0.8F, 0.8F, 0.8F);
                break;

            case "Poke":
                this.transformFirstPersonItem(equippedProgress, 1.0f);
                GlStateManager.rotate(-50.0F, 0.0F, 1.0F, 0.0F);
                f = -0.4F * MathHelper.sin(MathHelper.sqrt_float(swingProgress) * (float) Math.PI);
                f1 = 0.2F * MathHelper.sin(MathHelper.sqrt_float(swingProgress) * (float) Math.PI * 2.0F);
                float f2 = -0.2F * MathHelper.sin(swingProgress * (float) Math.PI);
            ...
            case "Exhi Swang":
                GL11.glTranslated(-0.09D, 0.25, 0.0D);
                this.transformFirstPersonItem(equippedProgress / 2.0F, swingProgress);
                f = MathHelper.sin((float) (MathHelper.sqrt_float(swingProgress) * Math.PI));
                GL11.glTranslated(this.mc.thePlayer.isSneaking() ? -0.03D : 0.1D, this.mc.thePlayer.isSneaking() ? 0.0D : -0.0D, 0.1D);
            ...
            case "Exhi Swong":
                ...
                GL11.glTranslated(0.1D, 0.55D, 0.0D);
                f = MathHelper.sin((float) (MathHelper.sqrt_float(swingProgress) * Math.PI));
                GL11.glRotated(-f * 65.0F / 2.0F, -f / 2.0F, -0.0F, 9.0F);
                GL11.glRotated(-f * 53.0F, 1.0F, f / 2.0F, -0.0F);
                this.doBlockTransformations2();
                break;

            case "Exhi Swank":
                this.transformFirstPersonItem(equippedProgress / 2.0F, swingProgress);
                f = MathHelper.sin(MathHelper.sqrt_float(swingProgress) * 3.1415927F);
                GlStateManager.rotate(f * 30.0F, -f, -0.0F, 9.0F);
                GlStateManager.rotate(f * 40.0F, 1.0F, -f, -0.0F);
                this.doBlockTransformations();
                break;
            ...
            default:
                ...
                GlStateManager.rotate(-f / 19.0F, f / 20.0F, -0.0F, 9.0F);
                GlStateManager.rotate(-f * 5.0F, 10.0F, f / 50.0F, 0.0F);
